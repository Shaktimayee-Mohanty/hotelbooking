...
const RoomDetails = () => {
 ...
 const [checkInDate, setCheckInDate] = useState(null);
  ...
  //check if the room is available for the selected dates and number of guests
  const checkAvailability = async()=>{
    try{
      //check is checkin date is greater than check out date
  ...
  //onsubmithandler to check the availability and navigate to booking page with query params
