...
const Dashboard = () => {
     ...
     const fetchDashboardData = async()=>{
        try {
            ...
            if(data.success){
                ...
                toast.error('Failed to fetch dashboard data:', data.message)
            }
        } catch (error) {
  ...
  return (
    <div>
        <Title align='left' font='outfit' title='Dashboard' subTitle='Moniter your room listings,track bookings and analyze revenue-all in one place. Stay updates with real-time insights to ensure smooth operations.'/>
